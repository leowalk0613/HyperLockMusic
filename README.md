...
- **官方高清封面** — 网易云 / QQ 音乐播放时，经媒体会话识别曲目后拉取官方高清图替换前景大专辑（无需 hook 播放器；其他播放器不匹配）；数据归各平台所有，图像版权归原作者所有
- **锁屏常亮** — 可选音乐锁屏时保持屏幕常亮
...
| **专辑封面** | 大封面 / 沉浸封面（含效果图预览）、大小位置圆角、上下暗角渐变、官方高清封面（网易云 / QQ） |
...
- 「官方高清封面」在网易云音乐或 QQ 音乐播放时生效（无需 hook 播放器）：**相关数据归各平台所有，图像版权归原作者所有**；仅供个人学习与本机显示，不会用其他播放器去匹配这两家封面
